...
class WordGenerator {
  ...
  static let possibleWords = ["BRUSH", "MEATS", "AUDIO", "TOUGH", "LAUGH", "MARCH", "SHARD", "LAYER", "FRANK", "SILLY", "PLAYS", "CAKES", "HEART", "NAMES", "CANDY", "TEARS", "FLUNK", "PARTY", "VAGUE", "LEMON", "FUDGE", "HEAVY", "PRINT"]
